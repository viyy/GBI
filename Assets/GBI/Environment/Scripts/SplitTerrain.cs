...
public class SplitTerrain : EditorWindow {
	...
	void OnGUI()
    {
        ...
        //terrainsCount = EditorGUILayout.IntSlider("Количество объектов", _countObject, 1, 100);
        terrainsCount = EditorGUILayout.IntField("Количество объектов", terrainsCount);
